...
if size(close_points,1) == 0
    labeled_points.common = {};
    labeled_points.exclusive = points{2};
    labeled_points.all = points{2};
elseif size(points{2},1) == 0
    labeled_points.common = {};
    labeled_points.exclusive = close_points;
    labeled_points.all = close_points;
else
